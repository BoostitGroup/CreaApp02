...
return [
    ...
    */
    ...
    "after"            => "La :attribute doit être une date postérieure a la :date.",
    ...
    "max"              => array(
        ...
        "string"  => "Le chmp :attribute ne peut contenir plus de :max caractères.",
    ),
    ...
    "size"             => array(
        ...
        "string"  => "Le chmp :attribute doit contenir :size caractères.",
    ),
