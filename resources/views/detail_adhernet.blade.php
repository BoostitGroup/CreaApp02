...
<div class="card">
    ...
    <div class="card-header">
                   ...
                   <form action="adherent/{{$detail->id}}" method="POST">
                     @if(Auth::user()->role==1)
                   <a href="{{url('admin/requete')}}" class="btn btn-info ">SOLLICITER LES MODIFICATIONS</a>
                   @endif
                   <a href="{{url('admin/adherent')}}" class="btn btn-danger "><i class="fa fa-times"></i></a>
                   </form>
           ...
           <table >
            <thead>
                        ...
                        <div class="row">
                          <div class="col-12 col-sm-15">
                            <div class="info-box bg-light">
                              <div  style="background-color: lightgray" class="info-box-content">
                ...
                <thead class="thead-light">
                  ...
                  <th><h3 style="color: black">Informations Supplémentaires:</h3></th>
                  <tr>
                ...
                @endforeach</td></tr>
                  ...
                  <td>{{$detail->DateCotisation}}</td>
                </tr>
              </tr>
            </thead>

        </table>
        <h3 style="color: black">Informations de l'adhérent:</h3>
